...
const Cart = () => {
  ...
  if (!cart) return null; // Prevent rendering before cart is initialized
  ...
  return (
    <>
      ...
      <Head>
        <link
          rel="preload"
          href="/_next/static/media/shopimg.73f9e6dd.png"
          as="image"
          type="image/png"
        />
      </Head>
      ...
      <div className="container mx-auto px-4 sm:px-8 py-8">
        ...
        <div className="relative">
          <Image
            ...
            loading="eager" // This makes sure the image is loaded as quickly as possible
